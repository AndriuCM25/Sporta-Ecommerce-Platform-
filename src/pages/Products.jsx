...
const Products = ({ addToCart, viewProductDetail, user, onShowAuth }) => {
  ...
  const products = [
    { id:1, name:'Air Sprint Pro',    category:'running',    price:449.99, image:'/src/assets/shoe1.jpg', badge:'Nuevo' },
    { id:2, name:'Urban Pulse NMD',   category:'lifestyle',  price:399.99, image:'/src/assets/shoe2.jpg', badge:'Popular' },
    { id:3, name:'Classic Strike',    category:'lifestyle',  price:349.99, image:'/src/assets/shoe3.jpg', badge:'Clásico' },
    { id:4, name:'Court Force Low',   category:'basketball', price:379.99, image:'/src/assets/shoe4.jpg', badge:'Retro' },
    { id:5, name:'ZX Boost Radical',  category:'running',    price:419.99, image:'/src/assets/shoe5.jpg', badge:'Boost' },
    { id:6, name:'Stan Legend',       category:'lifestyle',  price:329.99, image:'/src/assets/shoe6.jpg', badge:'Icono' },
  ]
